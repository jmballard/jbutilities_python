...
# functions to test
import data_creation, data_quality
...
def test_data_creation():
    ...
    expected = pd.DataFrame(
        {
            'id' : range(10),
            'num_1' : [
                0.471435,-1.190976,1.432707,-0.312652,-0.720589,
                0.887163,0.859588,-0.636524,0.015696,-2.242685            
            ],
            'num2' : [
                0.689382,-0.031712,0.668054,0.488838,-0.679788,
                -1.307479,1.470304,-1.231027,0.958775,0.74049
            ],
            'bool1' : [
    ...
    actual = data_creation.create_df_rd(size = 10,
                 seed = 1234,
                 numerics = {"" : None,
                             "num2" : [0,1]},
                 booleans = {"bool1" : 0.5},
    ...
    expected = pd.DataFrame(
        {
            ...
            'type_cat_or_num' : ['Numerical', 'Numerical', 'Numerical', 'Numerical', 'Categorical'],
