...
def find_series(name_file, 
    ...
    if not isinstance(name_file, str):
        raise TypeError("The input 'name_file' is not of the correct format. Needs a string.")

    if not isinstance(type_file, str):
        raise TypeError("The input 'type_file' is not of the correct format. Needs a string.")
